  ...
  <div>
    ...
    <div class="container-fluid" id="main">
      <div class="row row-offcanvas row-offcanvas-left">
        <div
          class="col-md-3 col-lg-2 sidebar-offcanvas pl-0 sidebar-left"
          id="sidebar"
          role="navigation"
        >
        ...
        <div class="col main pt-5 mt-3">
          ...
          <hr />
          <p class="lead mt-5">
            Are you ready for Bootstap 4? It's the 4th generation of this
            popular responsive framework. Bootstrap 4 will include some
            interesting new features such as flexbox, 5 grid sizes (now
            ...
            <div class="col-lg-3 col-md-4">
              ...
              <div class="card card-inverse bg-inverse mt-3">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Flexbox is now the default, and Bootstrap 4 supports SASS
                    out of the box.
                  </p>
          ...
          <div class="card-columns mb-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">
                  With screens getting smaller, Bootstrap 4 introduces a new
                  grid breakpoint with the col-xl-* classes. This extra tier
                  extends the media query range all the way down to 576 px.
                  Eventhough the new XL tier would make one think it’s been
                  added to support extra large screens, it’s actually the
                  opposite.
                </p>
              </div>
            </div>
            ...
            <div class="card card-body text-right">
              <blockquote class="card-blockquote">
                <p>
                  There are also some interesting new text classes to uppercase
                  or capitalize.
                </p>
                <footer>
                  <small class="text-muted">
              ...
              <div class="card-body">
                <ul class="list-unstyled">
                  <li class="text-capitalize">
                    <code class="text-lowercase">text-capitalize</code>
            ...
            <div class="card card-body">
              ...
              <p class="card-text">
                So now that you've seen some of what Bootstrap 4 has to offer,
                    ...
                    <div class="list-group">
                      <a href="" class="list-group-item"
                        ><span class="float-right label label-info label-pill"
                          >44</span
                        >
                        <code>.panel</code> is now <code>.card</code></a
                      >
                      <a href="" class="list-group-item"
                        ><span class="float-right label label-info label-pill"
                          >8</span
                      ...
                      <a href="" class="list-group-item"
                        ><span class="float-right label label-info label-pill"
                          >23</span
                        >
                        <code>.badge</code> is now <code>.label-pill</code></a
                      >
            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                  ...
                  >
                    <p>
                      ...
                      smartphones and tablets, then proceed to laptop and
                      desktop layouts.
                    </p>
                  </div>
                  <div
              ...
              <p class="mt-4">
                <a href="/go/KrUO8QpyXP/bootstrao-4-dashboard" target="_ext"
                  >Get this Bootstrap 4 admin dashboard at Codeply</a
                >
              </p>
            </div>
            <!--/col-->
