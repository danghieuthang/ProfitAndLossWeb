      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            hidden: true,
            component: RouteView,
            meta: { title: 'Receipts in Store', keepAlive: false },
            children: [
              {
                ...
                meta: { title: 'Receipt in Store', keepAlive: false }
              },
              {
                ...
                meta: { title: 'Receipt Split', keepAlive: false }
              },
              {
                ...
                meta: { title: 'Receipt Details', keepAlive: true }
              }
            ]
          },
          {
            ...
            hidden: true,
            component: () => import('@/views/transactiondetail/ListTransactionDetail'),
