        ...
        children: [
          {
            ...
            meta: { title: 'Center', keepAlive: true, permission: [ 'user' ] }
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                meta: { title: 'Security Settings', hidden: true, keepAlive: true, permission: [ 'user' ] }
              },
              {
                path: '/account/settings/custom',
                name: 'CustomSettings',
                component: () => import('@/views/account/settings/Custom'),
                meta: { title: 'Custom Settings', hidden: true, keepAlive: true, permission: [ 'user' ] }
              },
              {
              ...
              },
              {
                ...
                meta: { title: 'Notification Settings', hidden: true, keepAlive: true, permission: [ 'user' ] }
              }
            ]
          }
        ]
